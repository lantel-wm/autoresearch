...
def build_experiment() -> ExperimentSpec:
    return ExperimentSpec(
        ...
        feature_expressions=[
            ...
            ("Corr($close, Log($volume+1), 5)", "alpha_corr5"),
            ("Corr($close, Log($volume+1), 20)", "alpha_corr20"),
            ("Corr($close/Ref($close,1), Log($volume/Ref($volume, 1)+1), 5)", "alpha_cord5"),
