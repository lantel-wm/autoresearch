...
def build_experiment() -> ExperimentSpec:
    return ExperimentSpec(
        description="[factor][paper] behavioral_trading negsalience_turn20_120",
        feature_expressions=[
            ...
            (
                "(0 - Min((($close / Ref($close, 1) - 1) * "
                "($turnover_rate / (Mean($turnover_rate, 120) + 1e-12))), 20))",
                "negsalience_turn20_120",
            ),
            (
