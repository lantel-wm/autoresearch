...
def build_experiment() -> ExperimentSpec:
    return ExperimentSpec(
        description="[factor][paper] trend_alignment mom_highprox_turn20_60",
        feature_expressions=[
            ...
            (
                ...
                "($close / (Max($high, 55) + 1e-12)) * "
                "(Mean($turnover_rate, 20) / (Mean($turnover_rate, 60) + 1e-12))",
                "mom_highprox_turn20_60",
            ),
            (
