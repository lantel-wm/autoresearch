...
def build_experiment() -> ExperimentSpec:
    return ExperimentSpec(
        description="[factor][paper] lowrisk_liquidity lefttail_change20_120",
        feature_expressions=[
            ...
            (
                ...
                "Mean((0 - Less($close / Ref($close, 1) - 1, 0)) * "
                "(0 - Less($close / Ref($close, 1) - 1, 0)), 120)) / "
                "(Mean((0 - Less($close / Ref($close, 1) - 1, 0)) * "
                "(0 - Less($close / Ref($close, 1) - 1, 0)), 120) + 1e-12))",
                "lefttail_change20_120",
            ),
            (
